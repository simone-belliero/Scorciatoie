...
'05\06\2021 - Ludvik Jerabek - Fixed section regex to read everything within brakets and trim
'
'**DISCLAIMER**
...
Public Class IniFile
    ...
    Public Function GetKeyValue_String(ByVal sSection As String, ByVal sKey As String) As String
    ...
    '  Returns a KeyValue in a certain section
    Public Function GetKeyValue_Integer(ByVal sSection As String, ByVal sKey As String) As Integer
        Dim s As IniSection = GetSection(sSection)
        If s IsNot Nothing Then
            Dim k As IniSection.IniKey = s.GetKey(sKey)
            If k IsNot Nothing Then
    ...
    Public Function SetKeyValue_String(ByVal sSection As String, ByVal sKey As String, ByVal sValue As String) As Boolean
    ...
    ' Sets a KeyValuePair in a certain section
    Public Function SetKeyValue_Integer(ByVal sSection As String, ByVal sKey As String, ByVal sValue As Integer) As Boolean
        Dim s As IniSection = AddSection(sSection)
        If s IsNot Nothing Then
            Dim k As IniSection.IniKey = s.AddKey(sKey)
            If k IsNot Nothing Then
