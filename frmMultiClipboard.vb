...
Public Class frmMultiClipboard
...
#End Region
    ...
    Const C_EMPTY_CLIPBOARD = "==== EMPTY CLIPBOARD ===="
...
#Region "----------------- Private variables ---------------------------------"
    ...
    PrivateMy_Settings.ClipboardElementsNumber As Integer = 8

    Private _fixed_element_list As New List(Of ClipboardElement)
    Private _element_list As New List(Of ClipboardElement)
...
#Region "----------------- Public properties ---------------------------------"
    ...
    Public Property ElementsNumber As Integer
        Get
            ReturnMy_Settings.ClipboardElementsNumber
        End Get
        Set(value As Integer)
            My_Settings.ClipboardElementsNumber = value
        End Set
    End Property
    ...
    Public Property FixedElementList As List(Of ClipboardElement)
        Get
            Return _fixed_element_list
        End Get
        Set(value As List(Of ClipboardElement))
            _fixed_element_list = value
        End Set
    End Property

    Public Property ElementList As List(Of ClipboardElement)
        Get
...
#Region "----------------- FORM EVENTS ---------------------------------"
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'If _clipboard_fixed_lines.Count > 0 Then
        '    For Each F In _clipboard_fixed_lines
        '        Dim EL As New ClipboardElement(F)
        '        trovato = True
        '        ElementList.Add(EL)
        '    Next
        'End If
        ...
        If My.Computer.Clipboard.ContainsText Then
            Dim EL As New ClipboardElement(My.Computer.Clipboard.GetText)
            trovato = True
            ElementList.Add(EL)
        End If
        ...
        If Not trovato Then
            Dim EL As New ClipboardElement(C_EMPTY_CLIPBOARD)
            ElementList.Add(EL)
        End If
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        Try
            ...
            If My.Computer.Clipboard.ContainsText Then
                ...
                If T <> LastClipboard Then
                    Dim find As Boolean = False
                    For Each EL In ElementList
                        If EL.Link = T Then
                            find = True
                            Exit For
                        End If
                    ...
                    If Not find Then
                        Dim EL As New ClipboardElement(T)
                        ElementList.Add(EL)
                        If ElementList.Last.Link.Trim = C_EMPTY_CLIPBOARD Then
                            ElementList.Remove(ElementList.First)
                        End If
                        If ElementList.Count > ElementsNumber Then ElementList.Remove(ElementList.First)
                        PopolaForm()
                    End If
...
#Region "--------------- FUNCTIONS ---------------------"
    ...
    Public Sub PopolaForm()
        ...
        Try
            ...
            For Each F As ClipboardElement In ElementList
                F.AutoSize = False
    ...
    Sub Aggiungi_Elemento(L As ClipboardElement)
        Try
    ...
    Sub EliminaElemento(L As ClipboardElement)
...
#Region "--------------- ELEMENTS EVENTS --------------"
    ...
    Private Sub Element_MouseClick(sender As Object, e As MouseEventArgs)
        ...
        If e.Button = MouseButtons.Left Then
            Try
                ...
                Dim L As ClipboardElement = DirectCast(sender, ClipboardElement)
    ...
    Private Sub Element_MouseEnter(sender As Object, e As EventArgs)
        Try
            ...
            Dim El As ClipboardElement = DirectCast(sender, ClipboardElement)
